...
- Built fully custom theme (no page builders)
- Modular template architecture
- Flexible content system powered by ACF
...
- Theme-level performance considerations

### JavaScript Utility Projects
- Focused on DOM manipulation and clean logic structure
...
I focus on building structured, maintainable frontends that are easy to extend and integrate. I adapt quickly to new stacks and enjoy working within diverse systems — from traditional CMS platforms to modern JavaScript applications.
