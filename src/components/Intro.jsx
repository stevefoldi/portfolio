import heroLaptop from "/images/hero-laptop.svg";
	...
	return (
		<section className="intro-section">
			<div className="hero-section fader-stage">
				...
				<span className="fader-slide fader-slide--1">
					<i className="fa-brands fa-css3-alt"></i>
				</span>
				<span className="fader-slide fader-slide--2">
					<i className="fa-brands fa-html5"></i>
				</span>
				<span className="fader-slide fader-slide--3">
					<i className="fa-brands fa-square-js"></i>
				</span>
				<span className="fader-slide fader-slide--4">
					<i className="fa-brands fa-react"></i>
				</span>
				<span className="fader-slide fader-slide--5">
